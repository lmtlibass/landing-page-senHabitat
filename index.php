      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
            ...
            <h1>Achat et Vente de Maisons (à venir)</h1>
            <h2>Trouvez votre chez-vous idéal, vendez avec facilité!
              Achetez et vendez des maisons en toute simplicité avec notre application!</h2>
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h2>A propos de SenEspace</div>

          <div class="row content">
            <div class="col-lg-6">
              <p>
                Espacene plateforme conviviale, localisée et
                ...
                <ul>
                  <li>
                    <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span>
                      Expertise Localisée<i class="bx bx-chevron-down icon-show"></i><i
                  ...
                  <li>
                    <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span>
                      Listings Complets <i class="bx bx-chevron-down icon-show"></i><i
                        class="bx bx-chevron-up icon-close"></i></a>
                  ...
                  <li>
                    <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span>
                      Autonomisation de l'Utilisateur <i class="bx bx-chevron-down icon-show"></i><i
                        class="bx bx-chevron-up icon-close"></i></a>
          ...
          <div class="row">
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
              <form action="forms/contact.php" method="post"  class="php-email-form">
                ...
                <div class="my-3">
                  <div class="loading">Vueillez patienter</div>
                  <div class="error-message"></div>
                  <div class="sent-message">Votre message est envoyé avec succés. Merci!</div>
                </div>
